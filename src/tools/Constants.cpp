...
namespace Echoes
{
    namespace Dbo
    {
        ...
        const char *Constants::T_USER_HIERARCHY_UHI = TABLE_PREFIX SEP "USER_HIERARCHY" SEP TRIGRAM_USER_HIERARCHY;
        ...
        const char *Constants::T_ORGANIZATION_TYPE_OTY = TABLE_PREFIX SEP "ORGANIZATION_TYPE" SEP TRIGRAM_ORGANIZATION_TYPE;
        ...
        const char *Constants::T_ADDON_ADO = TABLE_PREFIX SEP "ADDON" SEP TRIGRAM_ADDON;
        ...
        const char *Constants::T_ALERT_MESSAGE_DEFINITION_AMD = TABLE_PREFIX SEP "ALERT_MESSAGE_DEFINITION" SEP TRIGRAM_ALERT_MESSAGE_DEFINITION;
        ...
        const char *Constants::T_ENGINE_ENG = TABLE_PREFIX SEP "ENGINE" SEP TRIGRAM_ENGINE;
        const char *Constants::T_SOURCE_SRC = TABLE_PREFIX SEP "SOURCE" SEP TRIGRAM_SOURCE;
        const char *Constants::T_SOURCE_PARAMETER_SRP = TABLE_PREFIX SEP "SOURCE_PARAMETER" SEP TRIGRAM_SOURCE_PARAMETER;
        ...
        const char *Constants::T_SEARCH_TYPE_STY = TABLE_PREFIX SEP "SEARCH_TYPE" SEP TRIGRAM_SEARCH_TYPE;
        ...
        const char *Constants::T_OPTION_VALUE_OPV = TABLE_PREFIX SEP "OPTION_VALUE" SEP TRIGRAM_OPTION_VALUE;
        const char *Constants::T_MEDIA_VALUE_MEV = TABLE_PREFIX SEP "MEDIA_VALUE" SEP TRIGRAM_MEDIA_VALUE;

        const char *Constants::TR_ALERT_CRITERIA_ACR = TABLE_REFERENCE_PREFIX SEP "ALERT_CRITERIA" SEP TRIGRAM_ALERT_CRITERIA;
        const char *Constants::TR_MEDIA_MED = TABLE_REFERENCE_PREFIX SEP "MEDIA" SEP TRIGRAM_MEDIA;
        const char *Constants::TR_OPTION_OPT = TABLE_REFERENCE_PREFIX SEP "OPTION" SEP TRIGRAM_OPTION;
