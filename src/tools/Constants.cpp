...
namespace Echoes
{
  namespace Dbo
  {
    ...
    const char *Constants::T_GROUP_GRP = TABLE_PREFIX SEP "GROUP" SEP TRIGRAM_GROUP;
    const char *Constants::T_GROUP_VALUE_GVA = TABLE_PREFIX SEP "GROUP_VALUE" SEP TRIGRAM_GROUP_VALUE;
    const char *Constants::T_GROUP_FIELD_GFI = TABLE_PREFIX SEP "GROUP_FIELD" SEP TRIGRAM_GROUP_FIELD;
...
//    const char *Constants::T_INFORMATION_SUB_UNIT_ISU = TABLE_PREFIX SEP "INFORMATION_SUB_UNIT" SEP TRIGRAM_INFORMATION_SUB_UNIT;
    ...
    const char *Constants::TR_GROUP_TYPE_GTY = TABLE_REFERENCE_PREFIX SEP "GROUP_TYPE" SEP TRIGRAM_GROUP_TYPE;
