...
namespace Echoes
{
  namespace Dbo
  {
    ...
    const char *Constants::T_ORGANIZATION_ORG = TABLE_PREFIX SEP "ORGANIZATION" SEP TRIGRAM_GROUP;
    const char *Constants::T_ORGANIZATION_VALUE_OVA = TABLE_PREFIX SEP "ORGANIZATION_VALUE" SEP TRIGRAM_GROUP_VALUE;
    const char *Constants::T_ORGANIZATION_FIELD_OFI = TABLE_PREFIX SEP "ORGANIZATION_FIELD" SEP TRIGRAM_GROUP_FIELD;
...
//    const char *Constants::T_INFORMATION_SUB_UNIT_ISU = TABLE_PREFIX SEP "INFORMATION_SUB_UNIT" SEP TRIGRAM_INFORMATION_SUB_UNIT;
    ...
    const char *Constants::TR_ORGANIZATION_TYPE_OTY = TABLE_REFERENCE_PREFIX SEP "ORGANIZATION_TYPE" SEP TRIGRAM_GROUP_TYPE;
    ...
    const char *Constants::TJ_ENG_ORG = TABLE_JOINT_PREFIX SEP TRIGRAM_ENGINE SEP TRIGRAM_GROUP;
