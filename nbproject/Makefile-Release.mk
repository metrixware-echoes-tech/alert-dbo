...
${OBJECTDIR}/src/alert/AlertAcknowledge.o: src/alert/AlertAcknowledge.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/alert/AlertAcknowledge.o src/alert/AlertAcknowledge.cpp

${OBJECTDIR}/src/plugin/Search.o: src/plugin/Search.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/plugin
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/plugin/Search.o src/plugin/Search.cpp
...
${OBJECTDIR}/src/tools/Session.o: src/tools/Session.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/tools/Session.o src/tools/Session.cpp

${OBJECTDIR}/src/user/Space.o: src/user/Space.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/user
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/user/Space.o src/user/Space.cpp

${OBJECTDIR}/src/media/MediaValue.o: src/media/MediaValue.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/media
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/media/MediaValue.o src/media/MediaValue.cpp

${OBJECTDIR}/src/alert/AlertValue.o: src/alert/AlertValue.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/alert
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/alert/AlertValue.o src/alert/AlertValue.cpp

${OBJECTDIR}/src/plugin/SourceParameter.o: src/plugin/SourceParameter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/plugin
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/plugin/SourceParameter.o src/plugin/SourceParameter.cpp

${OBJECTDIR}/src/media/Media.o: src/media/Media.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/media
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/media/Media.o src/media/Media.cpp

${OBJECTDIR}/src/tools/AuthApplication.o: src/tools/AuthApplication.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tools
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/tools/AuthApplication.o src/tools/AuthApplication.cpp

${OBJECTDIR}/src/alert/AlertType.o: src/alert/AlertType.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/alert
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/alert/AlertType.o src/alert/AlertType.cpp

${OBJECTDIR}/src/probe/Probe.o: src/probe/Probe.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/probe
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/probe/Probe.o src/probe/Probe.cpp
...
${OBJECTDIR}/src/alert/AlertParam.o: src/alert/AlertParam.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/alert
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/alert/AlertParam.o src/alert/AlertParam.cpp

${OBJECTDIR}/src/plugin/SearchParameterValue.o: src/plugin/SearchParameterValue.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/plugin
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/plugin/SearchParameterValue.o src/plugin/SearchParameterValue.cpp
...
${OBJECTDIR}/src/information/InformationHistoricalValue.o: src/information/InformationHistoricalValue.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/information/InformationHistoricalValue.o src/information/InformationHistoricalValue.cpp
...
${OBJECTDIR}/src/user/UserHierarchy.o: src/user/UserHierarchy.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/user
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/user/UserHierarchy.o src/user/UserHierarchy.cpp
...
${OBJECTDIR}/src/asset/Asset.o: src/asset/Asset.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/asset/Asset.o src/asset/Asset.cpp
...
${OBJECTDIR}/src/plugin/SearchType.o: src/plugin/SearchType.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/plugin
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/plugin/SearchType.o src/plugin/SearchType.cpp
...
${OBJECTDIR}/src/alert/AlertTrackingEvent.o: src/alert/AlertTrackingEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/alert
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/alert/AlertTrackingEvent.o src/alert/AlertTrackingEvent.cpp

${OBJECTDIR}/src/plugin/SourceParameterValue.o: src/plugin/SourceParameterValue.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/plugin
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/plugin/SourceParameterValue.o src/plugin/SourceParameterValue.cpp
...
${OBJECTDIR}/src/alert/AlertCriteria.o: src/alert/AlertCriteria.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/alert
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/alert/AlertCriteria.o src/alert/AlertCriteria.cpp

${OBJECTDIR}/src/alert/Alert.o: src/alert/Alert.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/alert
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/alert/Alert.o src/alert/Alert.cpp

${OBJECTDIR}/src/user/UserValue.o: src/user/UserValue.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/user
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/user/UserValue.o src/user/UserValue.cpp

${OBJECTDIR}/src/user/UserRole.o: src/user/UserRole.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/user
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/user/UserRole.o src/user/UserRole.cpp

${OBJECTDIR}/src/user/UserHistoricalAction.o: src/user/UserHistoricalAction.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/user
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/user/UserHistoricalAction.o src/user/UserHistoricalAction.cpp

${OBJECTDIR}/src/alert/AlertTracking.o: src/alert/AlertTracking.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/alert
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/alert/AlertTracking.o src/alert/AlertTracking.cpp

${OBJECTDIR}/src/user/UserRight.o: src/user/UserRight.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/user
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/user/UserRight.o src/user/UserRight.cpp
...
${OBJECTDIR}/src/user/User.o: src/user/User.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/user
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/user/User.o src/user/User.cpp

${OBJECTDIR}/src/organization/OrganizationField.o: src/organization/OrganizationField.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/organization
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/organization/OrganizationField.o src/organization/OrganizationField.cpp

${OBJECTDIR}/src/user/UserField.o: src/user/UserField.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/user
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/user/UserField.o src/user/UserField.cpp
...
${OBJECTDIR}/src/unit/InformationUnit.o: src/unit/InformationUnit.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/unit/InformationUnit.o src/unit/InformationUnit.cpp

${OBJECTDIR}/src/unit/InformationUnitType.o: src/unit/InformationUnitType.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/unit
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/unit/InformationUnitType.o src/unit/InformationUnitType.cpp

${OBJECTDIR}/src/plugin/Source.o: src/plugin/Source.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/plugin
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/plugin/Source.o src/plugin/Source.cpp

${OBJECTDIR}/src/pack/Pack.o: src/pack/Pack.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/pack
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/pack/Pack.o src/pack/Pack.cpp

${OBJECTDIR}/src/plugin/SearchParameter.o: src/plugin/SearchParameter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/plugin
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/plugin/SearchParameter.o src/plugin/SearchParameter.cpp

${OBJECTDIR}/src/pack/Option.o: src/pack/Option.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/pack
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/pack/Option.o src/pack/Option.cpp

${OBJECTDIR}/src/user/AccessControlList.o: src/user/AccessControlList.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/user
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/user/AccessControlList.o src/user/AccessControlList.cpp

${OBJECTDIR}/src/information/InformationValue.o: src/information/InformationValue.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/information
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/information/InformationValue.o src/information/InformationValue.cpp
