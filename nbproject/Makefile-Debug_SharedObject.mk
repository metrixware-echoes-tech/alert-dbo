...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libdbo.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libdbo.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC
...
${OBJECTDIR}/src/alert/AlertMessageDefinition.o: src/alert/AlertMessageDefinition.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/alert
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++11 -pedantic -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/alert/AlertMessageDefinition.o src/alert/AlertMessageDefinition.cpp
...
${OBJECTDIR}/src/information/SyslogHistory.o: src/information/SyslogHistory.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/information
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++11 -pedantic -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/information/SyslogHistory.o src/information/SyslogHistory.cpp
...
${OBJECTDIR}/src/tools/Enums.o: src/tools/Enums.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tools
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++11 -pedantic -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/tools/Enums.o src/tools/Enums.cpp

${OBJECTDIR}/src/tools/PostgresConnector.o: src/tools/PostgresConnector.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tools
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++11 -pedantic -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/tools/PostgresConnector.o src/tools/PostgresConnector.cpp
...
${OBJECTDIR}/src/tools/SessionPool.o: src/tools/SessionPool.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tools
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++11 -pedantic -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/tools/SessionPool.o src/tools/SessionPool.cpp
...
${OBJECTDIR}/src/unit/InformationSubUnit.o: src/unit/InformationSubUnit.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++11 -pedantic -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/unit/InformationSubUnit.o src/unit/InformationSubUnit.cpp
