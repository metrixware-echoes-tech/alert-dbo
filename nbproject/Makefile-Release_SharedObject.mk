...
${OBJECTDIR}/src/media/MediaType.o: src/media/MediaType.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/media
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -Iinclude -std=c++0x -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/media/MediaType.o src/media/MediaType.cpp
...
${OBJECTDIR}/src/pack/OptionType.o: src/pack/OptionType.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/pack
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -Iinclude -std=c++0x -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/pack/OptionType.o src/pack/OptionType.cpp
