...
${OBJECTDIR}/src/plugin/Search.o: src/plugin/Search.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/plugin
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -Iinclude -std=c++0x -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/plugin/Search.o src/plugin/Search.cpp

${OBJECTDIR}/src/plugin/SearchParameter.o: src/plugin/SearchParameter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/plugin
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -Iinclude -std=c++0x -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/plugin/SearchParameter.o src/plugin/SearchParameter.cpp

${OBJECTDIR}/src/plugin/SearchParameterValue.o: src/plugin/SearchParameterValue.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/plugin
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -Iinclude -std=c++0x -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/plugin/SearchParameterValue.o src/plugin/SearchParameterValue.cpp

${OBJECTDIR}/src/plugin/SearchType.o: src/plugin/SearchType.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/plugin
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -Iinclude -std=c++0x -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/plugin/SearchType.o src/plugin/SearchType.cpp

${OBJECTDIR}/src/plugin/SearchUnit.o: src/plugin/SearchUnit.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/plugin
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -Iinclude -std=c++0x -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/plugin/SearchUnit.o src/plugin/SearchUnit.cpp

${OBJECTDIR}/src/plugin/Source.o: src/plugin/Source.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/plugin
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -Iinclude -std=c++0x -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/plugin/Source.o src/plugin/Source.cpp

${OBJECTDIR}/src/plugin/SourceParameter.o: src/plugin/SourceParameter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/plugin
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -Iinclude -std=c++0x -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/plugin/SourceParameter.o src/plugin/SourceParameter.cpp

${OBJECTDIR}/src/plugin/SourceParameterValue.o: src/plugin/SourceParameterValue.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/plugin
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -Iinclude -std=c++0x -fPIC -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/plugin/SourceParameterValue.o src/plugin/SourceParameterValue.cpp
