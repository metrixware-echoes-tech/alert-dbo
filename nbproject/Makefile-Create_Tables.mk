...
${OBJECTDIR}/src/filter/FilterParameterValue.o: src/filter/FilterParameterValue.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/filter
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++11 -pedantic -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/filter/FilterParameterValue.o src/filter/FilterParameterValue.cpp
...
${OBJECTDIR}/src/media/MediaType.o: src/media/MediaType.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/media
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++11 -pedantic -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/media/MediaType.o src/media/MediaType.cpp
...
${OBJECTDIR}/src/pack/OptionType.o: src/pack/OptionType.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/pack
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++11 -pedantic -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/pack/OptionType.o src/pack/OptionType.cpp
...
${OBJECTDIR}/src/tools/SafeTransaction.o: src/tools/SafeTransaction.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tools
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++11 -pedantic -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/tools/SafeTransaction.o src/tools/SafeTransaction.cpp
...
${OBJECTDIR}/src/user/UserActionType.o: src/user/UserActionType.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/user
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++11 -pedantic -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/user/UserActionType.o src/user/UserActionType.cpp
