...
LDLIBSOPTIONS=-Ldist/Debug_SharedObject/GNU-Linux-x86 -ldbo -lwtdbopostgres -lwt -lboost_signals -lboost_system
...
${OBJECTDIR}/src/information/SyslogHistory.o: src/information/SyslogHistory.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/information
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++11 -pedantic -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/information/SyslogHistory.o src/information/SyslogHistory.cpp
