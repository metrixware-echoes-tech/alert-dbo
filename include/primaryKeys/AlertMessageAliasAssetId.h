...
namespace Wt
{
    namespace Dbo
    {
        ...
        void field(Action& a, AlertMessageAliasAssetId& aaaid,
        ...
        template<>
        struct dbo_traits<AlertMessageAliasAsset> : public dbo_default_traits
        {
            typedef AlertMessageAliasAssetId IdType;
            static IdType invalidId() { return AlertMessageAliasAssetId(); }
